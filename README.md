...
"PL%2FSQL" (https://img.shields.io/badge/PL%2FSQL-F80000?style=flat-square&logo=oracle&logoColor=white)
...
The goal is to centralize information from:
...
The project includes work with IP and 4G cameras, HTTP integrations, webhooks, event processing and remote device control.

---

AI-assisted Development

Experiments with language models applied to development workflows and specialized assistants.
